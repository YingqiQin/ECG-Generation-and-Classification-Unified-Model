...
def build_upperarm_inference_bundle(
    *,
    ...
    inference_data_keys = [
        ...
        "fallback_fs",
        "target_fs",
        "quality_preprocess_mode",
        "quality_preprocess_project_root",
        "quality_preprocess_script_path",
        "quality_preprocess_python",
        "quality_preprocess_output_root",
        "quality_preprocess_output_subdir",
        "quality_preprocess_use_cache",
        "quality_preprocess_force",
        "quality_preprocess_fs",
        "quality_preprocess_uc_thr",
        "quality_preprocess_gpu",
        "quality_preprocess_infer_batch",
        "quality_preprocess_step_sec",
    ]
    inference_config = {
