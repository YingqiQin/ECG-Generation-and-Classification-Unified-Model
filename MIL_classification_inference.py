...
def build_argparser():
    ...
    parser.add_argument("--embedding-dim", type=int, default=1024, help="Encoder embedding dimension. Keep this aligned with the checkpoint; ECGFounder-derived encoders are typically 1024.")
    parser.add_argument(
        "--lead-mode",
        type=str,
        default="12",
